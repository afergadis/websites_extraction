...
# APE dictionary
# inp= r"C:\Users\c.borovilou\PycharmProjects\pythonProject3\ape_dict.csv"
# file = open(inp, "r", encoding="utf8")
# ape_dict_list = list(csv.reader(file, delimiter=","))[0]
# file.close()


# print(stopwords.words('greek'))

# trg_path =  r"C:\Users\c.borovilou\Desktop\MSc\διπλωματική\boilerplate_removal\clean_1"       #-28.02
# path = r"C:\Users\c.borovilou\Desktop\MSc\διπλωματική\boilerplate_removal\clean_websites"
path = r"C:\Users\c.borovilou\Desktop\MSc\διπλωματική\boilerplate_removal\15"
# path = r"C:\Users\c.borovilou\Desktop\MSc\διπλωματική\1 test"

# os.chdir(r'C:\Users\c.borovilou\Desktop\MSc\διπλωματική\boilerplate_removal\clean_websites')  #28.07
os.chdir(r'C:\Users\c.borovilou\Desktop\MSc\διπλωματική\boilerplate_removal\15')
...
with alive_bar(407) as bar:

    for f_name in os.listdir("."):
        # if f_name not in da_list:
        #     continue
        flag_fail = '1'
        i = i + 1
        all_tm_prod =  [] #cb 28.07
        all_ape_sent = []
        lv_ape_sent = []
        tm_prod = []
        all_tm_prod.clear()
        ...
        if num_of_files == 0:
            ...
            if flag_fail == '0':
                ...
                # print(tm_prod)
                # find_sent_with_tm(path_dir)       #28.07 cb
            # else:
            #     n_fail = 1
        else:
            ...
            for site in websites:
                ...
                if flag_fail == '0':
                    # print(path_dir)
                    # words_cnt, clean_words_cnt  =  count_words(path_dir)  #cb 28.07
...
# tonight = date.ctime()
tonight = '10'
# with open("C:/temp/st_nvg.csv", 'w', encoding='UTF8', newline='') as f:
with open("C:/temp/" + str(today) + '_' + str(tonight) + ".csv", 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
